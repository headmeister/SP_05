...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.data.Data=generuj(str2double(handles.pocet.String),handles.bity.Value+3);%generovani novych dat
...
handles.data.Zasumeny=zasum(handles.data.Modulovany,str2double(handles.sum.String));%zasumeni dat
axes(handles.axes2);
